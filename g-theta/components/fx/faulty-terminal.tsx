...
// Vendored from reactbits.dev (FaultyTerminal-TS-TW). Local changes:
// mousemove listens on window (the layer sits under pointer-events-none
// overlays), and dpr defaults SSR-safe.
